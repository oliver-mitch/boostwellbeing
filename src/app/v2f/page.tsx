  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://www.boostwellbeing.co.nz/v2f" />
      </Head>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white/80 mt-8">
              Questions? We're here to help. <Link href="/v2f/contact" className="underline hover:text-white">Contact us</Link>
            </p>
          </div>
        </div>
      </section>
